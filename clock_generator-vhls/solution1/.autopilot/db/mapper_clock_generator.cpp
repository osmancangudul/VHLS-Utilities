...
using hls::sim::Byte;
extern "C" void clock_generator(volatile void *);
extern "C" void apatb_clock_generator_hw(volatile void * __xlx_apatb_param_slow_clock_signal) {
using hls::sim::createStream;
  // DUT call
  clock_generator(__xlx_apatb_param_slow_clock_signal);
}
