...
$(ObjDir)/clock_generator-tb.cpp_pre.cpp.tb.o : clock_generator-tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling clock_generator-tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/clock_generator.cpp_pre.cpp.tb.o : clock_generator.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling clock_generator.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
