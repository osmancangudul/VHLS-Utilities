...
// wrapc file define:
#define AUTOTB_TVIN_slow_clock_signal "../tv/cdatafile/c.clock_generator.autotvin_slow_clock_signal.dat"
#define AUTOTB_TVOUT_slow_clock_signal "../tv/cdatafile/c.clock_generator.autotvout_slow_clock_signal.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_slow_clock_signal "../tv/rtldatafile/rtl.clock_generator.autotvout_slow_clock_signal.dat"
...
extern "C"
void clock_generator_hw_stub_wrapper(void*);

extern "C"
void apatb_clock_generator_hw(void* __xlx_apatb_param_slow_clock_signal)
{
  static hls::sim::Register port0 {
    .name = "slow_clock_signal",
    .width = 1,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_slow_clock_signal),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_slow_clock_signal),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_slow_clock_signal),
#endif
  };
  port0.param = __xlx_apatb_param_slow_clock_signal;
  ...
  try {
    ...
    clock_generator_hw_stub_wrapper(__xlx_apatb_param_slow_clock_signal);
