...
if {[file isfile clock_generator.autotvin.dat]} {
	file delete -force clock_generator.autotvin.dat
}

if {[file isfile clock_generator.autotvout.dat]} {
	file delete -force clock_generator.autotvout.dat
}
