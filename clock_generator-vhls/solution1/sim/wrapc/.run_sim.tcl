...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "clock_generator.autotvin.dat"
	set constFileTvOut       "clock_generator.autotvout.dat"
	set constFileHdlTvIn     "clock_generator.autohdltvin.dat"
	set constFileHdlTvOut    "clock_generator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
