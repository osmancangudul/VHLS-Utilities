...
$(ObjDir)/debouncer-tb.cpp_pre.cpp.tb.o : debouncer-tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling debouncer-tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/debouncer.cpp_pre.cpp.tb.o : debouncer.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling debouncer.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
