...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "debouncer.autotvin.dat"
	set constFileTvOut       "debouncer.autotvout.dat"
	set constFileHdlTvIn     "debouncer.autohdltvin.dat"
	set constFileHdlTvOut    "debouncer.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
