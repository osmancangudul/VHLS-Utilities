...
#define AUTOTB_TVOUT_sw "../tv/cdatafile/c.debouncer.autotvout_sw.dat"
#define AUTOTB_TVIN_out_r "../tv/cdatafile/c.debouncer.autotvin_out_r.dat"
#define AUTOTB_TVOUT_out_r "../tv/cdatafile/c.debouncer.autotvout_out_r.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_out_r "../tv/rtldatafile/rtl.debouncer.autotvout_out_r.dat"
...
extern "C"
void debouncer_hw_stub_wrapper(hls::sim::Byte<1>, void*);

extern "C"
void apatb_debouncer_hw(hls::sim::Byte<1> __xlx_apatb_param_sw, void* __xlx_apatb_param_out_r)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_sw),
#endif
  };
  port0.param = &__xlx_apatb_param_sw;
  ...
  try {
    ...
    debouncer_hw_stub_wrapper(__xlx_apatb_param_sw, __xlx_apatb_param_out_r);
