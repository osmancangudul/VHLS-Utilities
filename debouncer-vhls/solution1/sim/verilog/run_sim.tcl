...
if {[file isfile debouncer.autotvin.dat]} {
	file delete -force debouncer.autotvin.dat
}

if {[file isfile debouncer.autotvout.dat]} {
	file delete -force debouncer.autotvout.dat
}
