...
`define AUTOTB_DUT      debouncer
`define AUTOTB_DUT_INST AESL_inst_debouncer
`define AUTOTB_TOP      apatb_debouncer_top
`define AUTOTB_LAT_RESULT_FILE "debouncer.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "debouncer.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_debouncer_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00
`define AUTOTB_II 1
`define AUTOTB_LATENCY 0

`define AESL_DEPTH_sw 1
`define AESL_DEPTH_out_r 1
`define AUTOTB_TVIN_sw  "../tv/cdatafile/c.debouncer.autotvin_sw.dat"
`define AUTOTB_TVIN_sw_out_wrapc  "../tv/rtldatafile/rtl.debouncer.autotvin_sw.dat"
`define AUTOTB_TVOUT_out_r  "../tv/cdatafile/c.debouncer.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "../tv/rtldatafile/rtl.debouncer.autotvout_out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 16000;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 0;
parameter LENGTH_out_r = 1;
parameter LENGTH_sw = 1;
...
reg [0: 0] AESL_REG_sw = 0;
assign sw = AESL_REG_sw;
initial begin : read_file_process_sw
    integer fp;
    integer err;
    integer ret;
    integer proc_rand;
    ...
    transaction_idx = 0;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVIN_sw,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_sw);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            ret = $sscanf(token, "0x%x", AESL_REG_sw);
              if (ret != 1) begin
