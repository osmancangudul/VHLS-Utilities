...
using hls::sim::Byte;
extern "C" void debouncer(char, volatile void *);
extern "C" void apatb_debouncer_hw(char __xlx_apatb_param_sw, volatile void * __xlx_apatb_param_out_r) {
using hls::sim::createStream;
  // DUT call
  debouncer(__xlx_apatb_param_sw, __xlx_apatb_param_out_r);
}
